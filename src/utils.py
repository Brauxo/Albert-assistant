...
class Utils:
    ...
    def search_courses(query):
        ...
        try:
            ...
            response = ollama_client.chat(model=MODEL_NAME, messages=[{"role": "user", "content": ai_prompt}])
    ...
    def process_input(messages):
        ...
        try:
            ...
            response = ollama_client.chat(model=MODEL_NAME, messages=messages_with_prompt)
            return response['message']['content']
        except Exception as e:
            return f"Error: {e}"
